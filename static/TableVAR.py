...
POSE_TEXT = ["PC_DATASET_NA_sp1.0_n0.0_sw0.txt",
            "OLC_DATASET_NA_sp1.0_n0.0_sw0.txt", 
            "PPL_DATASET_NA_sp1.0_n0.0_sw0.txt",
            "PPLplus_DATASET_NA_sp0.5_n0.0_sw0.txt"]
...
POINT_TEXT = [f"OLC_{DATASET}_SPF_sp1.0_n0.0_sw0.txt",
              f"PPL_{DATASET}_TPF_sp1.0_n0.0_sw1.0.txt"]
...
QUALITY_SPARSITY = ["1.0", "0.5","0.25", "0.1","0.05"]
QUALITY_METIC = ["SSIM","PSNR"]
